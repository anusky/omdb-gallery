  ...
  return (
    <Layout>
      ...
      <div className="grid gap-y-10 my-5 md:my-7 xl:my-10">
        <Link passHref href="/">
          <div className="cursor-pointer bg-g4m-gray-default text-g4m-black-default py-2 px-6 rounded-full font-body text-xl font-black w-fit-content justify-between h-fit-content m-auto">
            Take me back home
          </div>
        </Link>
      </div>
